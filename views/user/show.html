...
<main class="flex-shrink-0">
    <div class="container">
        <h1 class="mt-5">Edit Account - {{ auth()->user()->username }}</h1>
        <p class="lead">Edit account {{ auth()->user()->username }} in G2Airline</p>
        <div class="row pt-5">
            <div class="col-12">
...
{{--                            <% } %>--}}
                    ...
                    <div class="mb-3">
                        ...
                        <a href="/" class="btn btn-primary btn-small btn-rounded">Home</a>
                    </div>
                </form>
            </div>
        </div>
